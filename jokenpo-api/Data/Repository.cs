...
namespace jokenpo_api.Data
{
    public class Repository : IRepository
    {
        ...
        public async Task<Restaurant[]> GetAllRestaurant()
        {
            IQueryable<Restaurant> query = _context.Restaurants;
            var c = query.ToArrayAsync();
        ...
        {
           // string[] resultJogada = { partida.JogadaJogador1.Substring(0,2) + partida.JogadaJogador2.Substring(0, 2), partida.JogadaJogador3.Substring(0, 2) };
